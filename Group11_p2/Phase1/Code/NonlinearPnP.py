...
def reprojection_error(
    params: np.ndarray, K: np.ndarray, xs: np.ndarray, Xs: np.ndarray
) -> np.ndarray:
    """
...
def nonlinearPnP(
    xs: np.ndarray, Xs: np.ndarray, K: np.ndarray, R0, T0
    ...
    :param xs: the correspondending 2D points in the new image
    :param Xs: the correspondending 3D points in the world that are the projection of the 2D points
    :param K: camera intrinsic matrix (3,3)
    :param R0: initial value used as initial parameters for the optimization, can come from linear pnp or pnpRansac in Wrapper
    :param T0: initial value used as initial parameters for the optimization, can come from linear pnp or pnpRansac in Wrapper
