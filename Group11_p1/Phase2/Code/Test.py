...
def main():
    ...
    if args.ModelType == "supervised":
        ...
        path = os.path.dirname(os.path.abspath(__file__)) + "/checkpoints/unsupervised.pt"
    ...
    # Evaluate
    avg_epe, avg_time = evaluate_model(model, dataset, device, batch_size=args.batch_size)
